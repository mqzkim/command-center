...
// 생성: 2026-08-31 22:30Z · 수동 편집 금지 (보정은 projects.overrides.json, 재생성: node build-projects.mjs)
const CC_PROJECTS = {
 "generatedAt": "2026-08-31 22:30Z",
 "roots": [
  "C:\\workspace",
  "C:\\Users\\my\\workspace"
 ],
 "ghSnapshot": "2026-08-31T21:03:31.297Z",
 "stages": [
  "intake",
  "repo_bootstrap",
  "mvp_prd",
 ...
 "items": [
  {
   ...
   "gh": {
    ...
    "recent": [
     {
      "date": "2026-08-30",
      "message": "evolve-run: 2026-08-31 pipeline artifacts"
     },
     {
      "date": "2026-08-30",
      "message": "evolve(2026-08-31): ledger commit sha 992540b"
     },
     {
      "date": "2026-08-30",
      "message": "evolve(2026-08-31): vladikk/modularity 지식화(c) — ~/.wiki concept balan…"
     }
    ],
    "issueTitles": []
   },
