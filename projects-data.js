...
// 생성: 2026-09-17 22:31Z · 수동 편집 금지 (보정은 projects.overrides.json, 재생성: node build-projects.mjs)
const CC_PROJECTS = {
 "generatedAt": "2026-09-17 22:31Z",
 "roots": [
  "C:\\workspace",
  "C:\\Users\\my\\workspace"
 ],
 "ghSnapshot": "2026-09-17T21:03:25.051Z",
 "stages": [
  "intake",
  "repo_bootstrap",
  "mvp_prd",
  ...
  },
  {
   ...
   "gh": {
    ...
    "recent": [
     {
      "date": "2026-09-16",
      "message": "evolve(2026-09-17): ledger commit sha fa75987 + gates G1~G4 증거 기입"
     },
     {
      "date": "2026-09-16",
      "message": "evolve(2026-09-17): infragate/capa 지식화(c) — capabilities.yaml 크로스 하네스…"
     },
     {
      "date": "2026-09-15",
      "message": "evolve(2026-09-16): ledger commit sha 7e66166 + gates G1~G4 증거 기입"
     }
    ],
    "issueTitles": []
   },
