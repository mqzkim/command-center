...
// 생성: 2026-08-29 22:30Z · 수동 편집 금지 (보정은 projects.overrides.json, 재생성: node build-projects.mjs)
const CC_PROJECTS = {
 "generatedAt": "2026-08-29 22:30Z",
 "roots": [
  "C:\\workspace",
  "C:\\Users\\my\\workspace"
 ],
 "ghSnapshot": "2026-08-29T21:03:22.691Z",
 "stages": [
  "intake",
  "repo_bootstrap",
  "mvp_prd",
 ...
 "items": [
  {
   ...
   "gh": {
    ...
    "recent": [
     {
      "date": "2026-08-28",
      "message": "evolve-run: 2026-08-29 pipeline artifacts"
     },
     {
      "date": "2026-08-28",
      "message": "evolve(2026-08-29): ledger commit sha dfc4ba7"
     },
     {
      "date": "2026-08-28",
      "message": "evolve(2026-08-29): ferdinandobons/startup-skill 스킬 채택(b) — ~/.claude…"
     }
    ],
    "issueTitles": []
   },
   ...
   "links": {
    ...
    "wiki": [
     ...
     "concepts/layer-separated-monitoring.md"
    ],
    "launch": null,
    "parent": null
   }
  ...
  },
  {
   ...
   "gh": {
    ...
    "recent": [
     {
      "date": "2026-08-25",
      "message": "knowledge: update blogger legacy theme QA"
     },
     {
      "date": "2026-08-25",
      "message": "knowledge: add TradingAgents order serialization audit"
     },
     {
      "date": "2026-08-25",
      "message": "knowledge: update blogger responsive layout gate"
     }
    ],
    "issueTitles": []
   },
