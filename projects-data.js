...
// 생성: 2026-08-30 22:30Z · 수동 편집 금지 (보정은 projects.overrides.json, 재생성: node build-projects.mjs)
const CC_PROJECTS = {
 "generatedAt": "2026-08-30 22:30Z",
 "roots": [
  "C:\\workspace",
  "C:\\Users\\my\\workspace"
 ],
 "ghSnapshot": "2026-08-30T21:03:21.538Z",
 "stages": [
  "intake",
  "repo_bootstrap",
  "mvp_prd",
 ...
 "items": [
  {
   ...
   "gh": {
    ...
    "recent": [
     {
      "date": "2026-08-29",
      "message": "evolve-run: 2026-08-30 pipeline artifacts"
     },
     {
      "date": "2026-08-29",
      "message": "evolve(2026-08-30): ledger commit sha 242bd36"
     },
     {
      "date": "2026-08-29",
      "message": "evolve(2026-08-30): Gentleman-Programming/engram 지식화(c) — ~/.wiki ent…"
     }
    ],
    "issueTitles": []
   },
