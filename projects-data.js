...
// 생성: 2026-09-16 22:31Z · 수동 편집 금지 (보정은 projects.overrides.json, 재생성: node build-projects.mjs)
const CC_PROJECTS = {
 "generatedAt": "2026-09-16 22:31Z",
 "roots": [
  "C:\\workspace",
  "C:\\Users\\my\\workspace"
 ],
 "ghSnapshot": "2026-09-16T21:03:27.130Z",
 "stages": [
  "intake",
  "repo_bootstrap",
  "mvp_prd",
  ...
  },
  {
   ...
   "gh": {
    ...
    "recent": [
     ...
     {
      "date": "2026-09-15",
      "message": "evolve(2026-09-16): snyk/agent-scan 지식화(c) — 09-15 이월 1순위 채택, ~/.wiki…"
     },
     {
      "date": "2026-09-14",
      "message": "evolve(2026-09-15): ledger commit sha 2fa8a18 + gates G1~G4 증거 기입"
     }
    ],
    "issueTitles": []
   },
