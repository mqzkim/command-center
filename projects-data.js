...
// 생성: 2026-09-01 22:30Z · 수동 편집 금지 (보정은 projects.overrides.json, 재생성: node build-projects.mjs)
const CC_PROJECTS = {
 "generatedAt": "2026-09-01 22:30Z",
 "roots": [
  "C:\\workspace",
  "C:\\Users\\my\\workspace"
 ],
 "ghSnapshot": "2026-09-01T21:03:27.835Z",
 "stages": [
  "intake",
  "repo_bootstrap",
  "mvp_prd",
 ...
 "items": [
  {
   ...
   "gh": {
    ...
    "recent": [
     ...
     {
      "date": "2026-08-31",
      "message": "evolve(2026-09-01): ledger commit sha fdd035c"
     },
     {
      "date": "2026-08-31",
      "message": "evolve(2026-09-01): §6 자기수정 trends.mjs 풀 재충전 — 소진 원인은 --sort stars 고정…"
     }
    ],
    "issueTitles": []
   },
